...
.light-theme{
    ...
    --footer-quote-color: #515a5a;

    --journey-font-color: #313131;
    --journey-title-color: #3D4351;
    --journey-primary-color: #FF6B6B;
...
.dark-theme{
    ...
    --footer-quote-color: rgba(202, 207, 210, .8);

    --journey-font-color: #a4acc4;
